...
hyper_parameter_group ={
    ...
    "seed": 3407,
    "out_dir": r'../model/Swin_Tr_224/test13',
    "log_file_name": "Swin_Tr_test13",
    "Open_Parral_Training": True,
    "initial_checkpoint": None,
    "no_log": False,   # 注意这个参数只在 NNI_SEARCH中使用 其他时候为False
    "Mixed_Precision_Open": True, # 是否开启混精度  以显著增加训练速度
    # 数据集设定
...
##########################################################如上代码 生成 对应的 10_fold csv文件 便于云端进行 svr boost 等一系列训练
    ...
    # 定义模型
    model = Swin_Tr_224_Model1_large_test13(pretrained=True)
