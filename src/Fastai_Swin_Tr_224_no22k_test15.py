...
# 2022年1月9日： Test13
# 1. 基于 Test11 演变 保持 Test11的一切设定
# 2. 同时Mixup 下调为 0.2

# 2022年1月10日： Test14
# 1. 基于 Test12 演变， 保持 Test12的一切设定
# 2. 学习率变更为 4e-5 以和nni#2搜索保持一致
# 3. 由于fastai原生不支持 AdamW优化器， 改为使用RAdam优化器
...
hyper_parameter_group ={
    # 主要环境参数设定
    "seed": RANDOMSEED,
    "out_dir": r"/storage/Kaggle_Pet_Finder/model/Swin_Tr_224/fastai_test15",
    "log_file_name": "Fastai_SwinTr_test15",
    # 数据集设定
...
def get_learner(fold_num):
    ...
    model = Swin_Tr_224_Model1_large_test9()
