...
# 待办： 使用 YOLOV5 先预处理   对于224 384模型   需要解决的一个很重要的问题就是分辨率的问题。 考虑使用YOLO提取图片中的重要部分
###############
import os
...
hyper_parameter_group ={
    ...
    "seed": RANDOMSEED,
    "out_dir": r"/storage/Kaggle_Pet_Finder/model/Swin_Tr_224/fastai_test3",
    "log_file_name": "Fastai_SwinTr_test3",
    # 数据集设定
