...
hyper_parameter_group ={
    ...
    "seed": 3407,
    "out_dir": r'../model/Swin_Tr_224/test10',
    "log_file_name": "Swin_Tr_test10",
    ...
    # test 4 9  swin_large_patch4_window7_224
    # test 8 swin_base_patch4_window12_384_in22k
    # test 10 swin_large_patch4_window12_384
...
if hyper_parameter_group["no_log"] == False:
    ...
    stdout('\n')
    copyfile("Train_Swin_Tr_Model3_test10.py", hyper_parameter_group["out_dir"] + "/source_code/train_source_code.py")
...
def validation(model, loader):
    ...
    if hyper_parameter_group["loss_type"] != "mser":
        ...
        msre_meric = mser_numpy_only_for_mserloss(test_models_logits, test_models_truth)
...
##########################################################如上代码 生成 对应的 10_fold csv文件 便于云端进行 svr boost 等一系列训练
    ...
    # 定义模型
    model = Swin_Tr_384_Model3_large_test10(pretrained=True)
