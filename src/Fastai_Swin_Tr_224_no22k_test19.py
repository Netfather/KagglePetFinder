...
# 2022年1月11日： Test19
# 2. 优化器设置为 RAdam 设置 Wd 和  Lookahead
# 3. 学习率保持为 2e-5
###############
import os
...
hyper_parameter_group ={
    # 主要环境参数设定
    "seed": RANDOMSEED,
    "out_dir": r"/storage/Kaggle_Pet_Finder/model/Swin_Tr_224/fastai_test19",
    "log_file_name": "Fastai_SwinTr_test19",
    # 数据集设定
...
def get_learner(fold_num):
    ...
    metrics= [AccumMetric(func=petfinder_rmse)]).to_fp32()
